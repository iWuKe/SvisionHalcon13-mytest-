...
namespace Svision
{
    class findAnisoShapeModelClass
    {
        ...
        public findAnisoShapeModelClass(/*int numberOfModelTemp*/)
        {
        ...
        private struct createAnisoShapeModelPara
        {
            ...
            public createAnisoShapeModelPara(int numberLevelsTemp, double angleStartTemp, double angleExtentTemp, double angleStepTemp, double scaleRMinTemp,
                                      double scaleRMaxTemp, double scaleRStepTemp, double scaleCMinTemp, double scaleCMaxTemp, double scaleCStepTemp,
        ...
        private createAnisoShapeModelPara createAnisoShapeModelP;
        public void setCreatAnisoShapeModelPara(int numberLevelsTemp, double angleStartTemp, double angleExtentTemp, double angleStepTemp, double scaleRMinTemp, 
                                     double scaleRMaxTemp,double scaleRStepTemp, double scaleCMinTemp, double scaleCMaxTemp, double scaleCStepTemp,
                                           int[] optimizationTemp, int metricTemp, int[] contrastTemp, int minContrastTemp)
        {
            createAnisoShapeModelP = new createAnisoShapeModelPara(numberLevelsTemp, angleStartTemp, angleExtentTemp, angleStepTemp, scaleRMinTemp, scaleRMaxTemp,
        ...
        public void inspectShapeModel(HObject templateHImage, HTuple hvWindowHandle)
        {
            ...
            try
            {
                ...
                HOperatorSet.InspectShapeModel(templateHImage, out modelImage, out modelregion, createAnisoShapeModelP.numberLevels, createAnisoShapeModelP.contrast);
        ...
        public void determineShapeModelParameters(HObject templateHImage, int[] index, out HTuple parameters)
        {
            ...
            try
            {
                ...
                HOperatorSet.DetermineShapeModelParams(templateHImage, createAnisoShapeModelP.numberLevels, createAnisoShapeModelP.angleStart, createAnisoShapeModelP.angleExtent,
                                 1,1,
                                createAnisoShapeModelP.optimization[0], createAnisoShapeModelP.metric, createAnisoShapeModelP.contrast, createAnisoShapeModelP.minContrast, "all", out hv_ParameterName, out hv_ParameterValue);
        ...
        public void createAnisoShapeModel(HObject templateHImage, out HTuple tModelID)
        {
            //Prepare a shape model for matching.And display the contour of model on the screen.
            try
            {
                HOperatorSet.CreateAnisoShapeModel(templateHImage, createAnisoShapeModelP.numberLevels, createAnisoShapeModelP.angleStart, createAnisoShapeModelP.angleExtent, createAnisoShapeModelP.angleStep,
                    createAnisoShapeModelP.scaleRMin,createAnisoShapeModelP.scaleRMax,createAnisoShapeModelP.scaleRStep,createAnisoShapeModelP.scaleCMin,createAnisoShapeModelP.scaleCMax,createAnisoShapeModelP.scaleCStep,            
                    createAnisoShapeModelP.optimization, createAnisoShapeModelP.metric, createAnisoShapeModelP.contrast, createAnisoShapeModelP.minContrast, out tModelID);
                //HObject modelImage, modelregion;
                ...
                //    HOperatorSet.SetLineWidth(hvWindowHandle, 4);
                //    HOperatorSet.DispObj(modelregion.SelectObj(1), hvWindowHandle);
                //}
                //modelregion.Dispose();
                //modelImage.Dispose();
            }
        ...
        //public void saveShapeModels(string fileName, string filePath)
        //{
        //    //Write the multiple shape model to a file with the name of fileName and the path filePath.
        //    for (int i = 0; i < numberOfModel; i++)
        //    {
        //        string fullFileName = filePath + fileName + i.ToString() + ".shm";
        //        HOperatorSet.WriteShapeModel(tModelID, (HTuple)fullFileName);
        //    }
        //}
        ...
        //public void readShapeModels(string fileName, string filePath)
        //{
        //    // Read the multiple shape model to a file with the name of fileName and the path filePath.
        //    for (int i = 0; i < numberOfModel; i++)
        //    {
        //        string fullFileName = filePath + fileName + i.ToString() + ".shm";
        //        HOperatorSet.ReadShapeModel((HTuple)fullFileName, out tModelID);
        ...
        //    }
        //}
        public struct findAnisoShapeModelPara
        {
            ...
            public findAnisoShapeModelPara(double angleStartTemp, double angleExtentTemp, double scaleRMinTemp, double scaleRMaxTemp, double scaleCMinTemp, 
                double scaleCMaxTemp, double minScoreTemp, int numMatchesTemp, double maxOverlapTemp, int[] subPixelTemp, int[] numLevelsTemp, double greedinessTemp)
        ...
        private findAnisoShapeModelPara findAnisoShapeModelP;
        public void setFindAnisoShapeModelPara(double angleStartTemp, double angleExtentTemp,double scaleRMinTemp,double scaleRMaxTemp,double scaleCMinTemp,double scaleCMaxTemp, double minScoreTemp,
                                        int numMatchesTemp, double maxOverlapTemp, int[] subPixelTemp, int[] numLevelsTemp, double greedinessTemp)
        {
            ...
            //{
            findAnisoShapeModelP = new findAnisoShapeModelPara(angleStartTemp, angleExtentTemp,scaleRMinTemp,scaleRMaxTemp,scaleCMinTemp,scaleCMaxTemp, minScoreTemp, numMatchesTemp, maxOverlapTemp, subPixelTemp, numLevelsTemp, greedinessTemp);
            //}
            //else
            //{
        ...
        public void findAnisoShapeModel(HObject DSTHImage, HTuple tModelID, HTuple hvWindowHandle, double sizeRate, out double[] rows,
                                    out double[] columns, out double[] angles,out double[] scaleR,out double[] scaleC, out double[] scores)
        {
            ...
            try
            {
                ...
                HTuple hscaleC = null;
                HTuple hScore = null;
                HOperatorSet.FindAnisoShapeModel(DSTHImage, tModelID, findAnisoShapeModelP.angleStart, findAnisoShapeModelP.angleExtent, findAnisoShapeModelP.scaleRMin,
                    findAnisoShapeModelP.scaleRMax, findAnisoShapeModelP.scaleCMin, findAnisoShapeModelP.scaleCMax, findAnisoShapeModelP.minScore, 
                    findAnisoShapeModelP.numMatches, findAnisoShapeModelP.maxOverlap, findAnisoShapeModelP.subPixel, findAnisoShapeModelP.numLevels, 
                    findAnisoShapeModelP.greediness, out hRow, out hColumn, out hAngle,out hscaleR,out hscaleC, out hScore);
                ...
                scaleR = new double[hscaleR.TupleLength()];
                for (int i = 0; i < hscaleR.TupleLength(); i++)
                {
                    scaleR[i] = hscaleR[i].D;
                }
                scaleC = new double[hscaleC.TupleLength()];
                for (int i = 0; i < hscaleC.TupleLength(); i++)
                {
                    scaleC[i] = hscaleC[i].D;
                }
        ...
        public void findAnisoShapeModel(HObject DSTHImage, HTuple tModelID, int arrangeIndexs, out double[] rows,
                                    out double[] columns, out double[] angles, out double[] scaleR, out double[] scaleC, out double[] scores)
        {
        ...
        public struct findAnisoShapeModelsPara
        {
            ...
            public HTuple greediness;
            //“Greediness” of the search heuristic (0: safe but slow; 1: fast but matches may be missed).
            public findAnisoShapeModelsPara(int numberOfModelTemp, double[] angleStartTemp, double[] angleExtentTemp, double[] scaleRMinTemp, double[] scaleRMaxTemp, double[] scaleCMinTemp,
                double[] scaleCMaxTemp, double[] minScoreTemp, int[] numMatchesTemp, double maxOverlapTemp, int[] subPixelTemp, int[] numLevelsTemp, double[] greedinessTemp)
            {
                angleStart = null;
                angleExtent = null;
                ...
                /*scaleRMin*/
                //ScaleRMin > 0 
                if (scaleRMinTemp.Length == 1)
                {
                    scaleRMin = (HTuple)scaleRMinTemp[0];
                }
                else if (scaleRMinTemp.Length == numberOfModelTemp)
                {
                    scaleRMin = (HTuple)scaleRMinTemp[0];
                    for (int i = 1; i < numberOfModelTemp; i++)
                    {
                        scaleRMin = scaleRMin.TupleConcat((HTuple)scaleRMinTemp[i]);
                    }
                }
                else
                {
                    throw new Exception("scaleRMinTemp error!");
                }
                /*scaleRMax*/
                //ScaleRMax > 0 
                if (scaleRMaxTemp.Length == 1)
                {
                    scaleRMax = (HTuple)scaleRMaxTemp[0];
                }
                else if (scaleRMaxTemp.Length == numberOfModelTemp)
                {
                    scaleRMax = (HTuple)scaleRMaxTemp[0];
                    for (int i = 1; i < numberOfModelTemp; i++)
                    {
                        scaleRMax = scaleRMax.TupleConcat((HTuple)scaleRMaxTemp[i]);
                    }
                }
                else
                {
                    throw new Exception("scaleRMaxTemp error!");
                }
                /*scaleCMin*/
                //ScaleCMin > 0 
                if (scaleCMinTemp.Length == 1)
                {
                    scaleCMin = (HTuple)scaleCMinTemp[0];
                }
                else if (scaleCMinTemp.Length == numberOfModelTemp)
                {
                    scaleCMin = (HTuple)scaleCMinTemp[0];
                    for (int i = 1; i < numberOfModelTemp; i++)
                    {
                        scaleCMin = scaleCMin.TupleConcat((HTuple)scaleCMinTemp[i]);
                    }
                }
                else
                {
                    throw new Exception("scaleCMinTemp error!");
                }
                /*scaleCMax*/
                //ScaleCMax > 0 
                if (scaleCMaxTemp.Length == 1)
                {
                    scaleCMax = (HTuple)scaleCMaxTemp[0];
                }
                else if (scaleCMaxTemp.Length == numberOfModelTemp)
                {
                    scaleCMax = (HTuple)scaleCMaxTemp[0];
                    for (int i = 1; i < numberOfModelTemp; i++)
                    {
                        scaleCMax = scaleCMax.TupleConcat((HTuple)scaleCMaxTemp[i]);
                    }
                }
                else
                {
                    throw new Exception("scaleCMaxTemp error!");
                }
        ...
        private findAnisoShapeModelsPara findAnisoShapeModelsP;
        public void setFindAnisoShapeModelsPara(int numberOfModelTemp, double[] angleStartTemp, double[] angleExtentTemp, double[] scaleRMinTemp, double[] scaleRMaxTemp, double[] scaleCMinTemp,
                double[] scaleCMaxTemp, double[] minScoreTemp,
                                        int[] numMatchesTemp, double maxOverlapTemp, int[] subPixelTemp, int[] numLevelsTemp, double[] greedinessTemp)
        {
            findAnisoShapeModelsP = new findAnisoShapeModelsPara(numberOfModelTemp, angleStartTemp, angleExtentTemp, scaleRMinTemp, scaleRMaxTemp, scaleCMinTemp,
                                        scaleCMaxTemp, minScoreTemp, numMatchesTemp, maxOverlapTemp, subPixelTemp, numLevelsTemp, greedinessTemp);
        }
        public void findAnisoShapeModels(HTuple tModelIDs, HObject DSTHImage, HTuple hvWindowHandle, double sizeRate, out double[] rows,
                                  out double[] columns, out double[] angles, out double[] scaleR, out double[] scaleC, out double[] scores, out int[] templateClassID)
        {
            ...
            try
            {
                ...
                HTuple hscaleC = null;
                HTuple hScore = null;
                HOperatorSet.FindAnisoShapeModels(DSTHImage, tModelIDs, findAnisoShapeModelsP.angleStart, findAnisoShapeModelsP.angleExtent, findAnisoShapeModelsP.scaleRMin,
                    findAnisoShapeModelsP.scaleRMax, findAnisoShapeModelsP.scaleCMin, findAnisoShapeModelsP.scaleCMax, findAnisoShapeModelsP.minScore, 
                    findAnisoShapeModelsP.numMatches, findAnisoShapeModelsP.maxOverlap, findAnisoShapeModelsP.subPixel, findAnisoShapeModelsP.numLevels,
                    findAnisoShapeModelsP.greediness, out hRow, out hColumn, out hAngle, out hscaleR, out hscaleC, out hScore, out tModelResultIDs);
                rows = new double[hRow.TupleLength()];
                for (int i = 0; i < hRow.TupleLength(); i++)
                {
                    rows[i] = hRow[i].D;
        ...
        public void findAnisoShapeModels(HTuple tModelIDs, HObject DSTHImage, int arrangeIndexs, out double[] rows,
                                 out double[] columns, out double[] angles, out double[] scaleR, out double[] scaleC, out double[] scores, out int[] templateClassID)
        {
